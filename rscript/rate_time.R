...
cols  <- c('black',    'black', 'black', 'black',    '#9f9b9b',  '#9f9b9b',  '#9f9b9b', 'black')
...
ggplot(data=dat, aes(x=x, y=y)) +
    ...
    geom_point(size=2, shape=19, colour=cols) +
    geom_text(aes(label=dates), nudge_y=log10(1.3), nudge_x=1300, colour=cols, cex=6) +
