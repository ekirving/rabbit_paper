...
class SNPsDataFile(IncompleteTask):
    """
...
class DadiSpectrum(IncompleteTask):
    """
    ...
    def requires(self):
        return SNPsDataFile(self.group, GENOME)
...
class DadiModelOptimizeParams(IncompleteTask):
    """
...
class DadiModelMaximumLikelihood(IncompleteTask):
    """
